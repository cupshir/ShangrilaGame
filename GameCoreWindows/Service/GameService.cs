    ...
    public class GameService
    {
        ...
        public static Game DetermineDealer(Game game)
        {
            ...
            for (int i = 2; i < 15; i++)
            {
                ...
                card.Value = CardService.GetValue(i);
                card.DealValue = i;
                deck.Cards.Add(card);
            }
        ...
        public static List<Player> CreateTestPlayers()
        {
            ...
            Player player2 = PlayerService.CreatePlayer("Carissa", 2);
            player2.SeatNumber = 2;
            Player player3 = PlayerService.CreatePlayer("Doug", 3);
            player3.SeatNumber = 3;
            Player player4 = PlayerService.CreatePlayer("Damien", 4);
            player4.SeatNumber = 4;
            Player player5 = PlayerService.CreatePlayer("Maddie", 5);
            player5.SeatNumber = 5;
            Player player6 = PlayerService.CreatePlayer("Box", 6);
            player6.SeatNumber = 6;
            Player player7 = PlayerService.CreatePlayer("Nicki", 7);
